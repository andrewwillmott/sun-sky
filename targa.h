...
* $Id: targa.h,v 1.3 2004/10/22 05:10:56 checker Exp $
*
...
#define TGA_UNUSED_BITS (uint8_t)(BIT(6)|BIT(7))
    ...
    void init_tga_image(tga_image *img, uint8_t *image, const uint16_t width, const uint16_t height, const uint8_t depth);
